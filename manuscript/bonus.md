...
Den Abschluss dieses Buchs soll ein Artikel bilden, der einige meiner konkreten Erfahrungen mit der Entwicklung von Frameworks widerspiegelt, und zwar der als Ideengeber und leitender Entwickler der damals ersten Google-Web-Frameworks Go (2008) und Maia (2012). Der Bericht ist eine leicht modifizierte Variante der Fassung, die Sie auch unter [meiert.com/de/publications/articles/20171005/](https://meiert.com/de/publications/articles/20171005/) finden.
...
Go war speziell, und das soll nicht als Eigenlob verstanden werden, sondern ist den einmaligen Umständen geschuldet. Go ist, und selbst [in minifizierter Form](https://www.google.com/css/go.css) kriegt man davon einen Eindruck, ein kompaktes Framework. Das ist _by design_. Aber wie wurde es entworfen, und warum? Dazu sollten wir nochmal auf Googles Landschaft an Websites blicken – ein Blick, der tatsächlich [Pflicht](https://meiert.com/en/blog/tailoring-frameworks/) ist, wenn wir Frameworks designen (aber auch [benutzen](https://meiert.com/en/blog/framework-rules/)).
